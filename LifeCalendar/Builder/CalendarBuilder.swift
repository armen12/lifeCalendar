...
class CalendarBuilder: CalendarBuilderProtocol{
    ...
    private func setupYears(myBirthday: Date, myDeath: Date){
        ...
        var index = 0
         for year in  myBirthday.year..<(myDeath.year+1){
            ...
            arrayOfyears.append(Year(date: date, index: year, titel: "", diaryEntry: "", media: StringObject(), emotion: Emotion.empty , isCurrentindex: false, isActive: false))
            index+=1
        }
    ...
    private  func setupMonth(myBirthday: Date, myDeath: Date){
        ...
        for month in 0..<(weeksOfLife){
            ...
            arrayOfMonth.append(Month(date: date, index: month, titel: "", diaryEntry: "", media: StringObject(), emotion: Emotion.empty , isCurrentindex: false, isActive: false))
        }
    ...
    private func setupWeeks(myBirthday: Date, myDeath: Date){
        ...
        for week in 0..<(weeksOfLife){
            ...
            arrayOfWeeks.append(Week(date: date, index: week, titel: "", diaryEntry: "", media: StringObject(), emotion: Emotion.empty , isCurrentindex: false, isActive: false))        }
    ...
    private func setupDays(myBirthday: Date, myDeath: Date){
        ...
        for day in 0..<(daysOfLife){
            ...
            arrayOfDays.append(Day(date: date, index: day, titel: "", diaryEntry: "", media: StringObject(), emotion: Emotion.empty , isCurrentindex: false, isActive: false))
        }
